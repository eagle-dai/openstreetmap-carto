@breakwater-color: darken(#aaa, 70%); /* Also for groyne */
@dam: darken(#adadad, 70%);
@dam-line: darken(#444444, 70%);
@weir-line: darken(#aaa, 70%);
@lock-gate: darken(#aaa, 70%);
@lock-gate-line: darken(#aaa, 70%);
